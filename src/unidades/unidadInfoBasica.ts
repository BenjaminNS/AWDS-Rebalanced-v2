...
export const ListaUnidades:listaUnidades = {
  ...
  'apc': {
    nombreLargo: 'APC', nombreCorto: 'apc', descripcion: 'Vehículo de transporte terrestre capaz de mover soldados y reponer municiones y gasolina a todas las unidades.', categorias: ['Vehiculo', 'Terrestre', 'Transporte'],
  ...
  'artilleria': {
    nombreLargo: 'Artillería', nombreCorto: 'artilleria', descripcion: 'Vehículo indirecto de corto alcance efectivo contra unidades terrestres y navales.', categorias: ['Vehiculo', 'Terrestre', 'Indirecto'], costo: 6000, rango: { minimo: 2, extra: 1 }, movilidad: 5, tipoMovimiento: 'oruga', vision: 2, maxGasolina: 50, consumoDiario: () => 0, maxMuniciones: { 'principal': { actual: 7, maxima: 7 } }, contraataque: 0, atacarYMoverse: false, matchups: artilleria_MU, sprite: spriteArtilleria
  },
  'cohetes': {
    nombreLargo: 'Cohetes', nombreCorto: 'cohetes', descripcion: 'Vehículo indirecto de largo alcance efectivo contra unidades terrestres y navales.', categorias: ['Vehiculo', 'Terrestre', 'Indirecto'], costo: 15000, rango: { minimo: 2, extra: 3 }, movilidad: 5, tipoMovimiento: 'ruedas', vision: 3, maxGasolina: 50, consumoDiario: () => 0, maxMuniciones: { 'principal': { actual: 6, maxima: 6 } }, contraataque: 0, atacarYMoverse: false, matchups: cohetes_MU, sprite: spriteCohetes
  },
  'tanqueAntiaereo': {
  ...
  'misiles': {
    nombreLargo: 'Misiles', nombreCorto: 'misiles', descripcion: 'Vehículo antiaéreo terrestre de largo alcance.', categorias: ['Vehiculo', 'Indirecto', 'Antiaereo'], costo: 12000, rango: { minimo: 2, extra: 3 }, movilidad: 5, tipoMovimiento: 'ruedas', vision: 5, maxGasolina: 50, consumoDiario: () => 0, maxMuniciones: { 'principal': { actual: 6, maxima: 6 } }, contraataque: 0, atacarYMoverse: false, matchups: misiles_MU, sprite: spriteMisiles
  },
  'bCopter': {
