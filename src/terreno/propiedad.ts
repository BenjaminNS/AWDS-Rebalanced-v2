...
export abstract class Propiedad extends Terreno{
  ...
  constructor (propiedad: {propietario: number|null, recompensas: Recompensa, opcionesCompra: nombreUnidad[]}, terreno: {descripcion: string, estrellasDefensa: number, nombreCorto: nombreTerreno, nombreLargo: string }){
