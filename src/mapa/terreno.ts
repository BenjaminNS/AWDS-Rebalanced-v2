...
export class Terreno {
  ...
  constructor (nombre: string, estrellasDefensa: number, descripcion: string, costosMovimientos: object, puedeOcultarEnFOW: boolean, esPropiedad: boolean, obtenerSprite: obtenerSpriteFn){
    this.nombre = nombre
